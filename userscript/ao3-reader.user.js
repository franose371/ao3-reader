...
// @supportURL   https://github.com/franose371/ao3-reader/issues
// @updateURL    https://raw.githubusercontent.com/franose371/ao3-reader/main/userscript/ao3-reader.user.js
// @downloadURL  https://raw.githubusercontent.com/franose371/ao3-reader/main/userscript/ao3-reader.user.js
...
(function () {
  ...
  // ── Injected CSS ────────────────────────────────────────────────────
  GM_addStyle(`
    /* AO3 Reader - Floating entry button */
    #ao3-reader-entry-btn {
      position: fixed;
      bottom: 24px;
      right: 16px;
      z-index: 9998;
    ...
    /* Theme variants */
    #ao3-reader-overlay.theme-light {
      background: #ffffff;
      color: #1a1a1a;
      --ao3-reader-card-bg: #ffffff;
    }
    #ao3-reader-overlay.theme-sepia {
      background: #f5f0e8;
      color: #3d3027;
      --ao3-reader-card-bg: #f5f0e8;
    }
    #ao3-reader-overlay.theme-dark {
      background: #1a1a1a;
      color: #d4d4d4;
      --ao3-reader-card-bg: #252525;
    }
    ...
    #ao3-reader-header .chapter-title {
      font-size: 13px;
      font-weight: bold;
      flex: 1;
      overflow: hidden;
    ...
    #ao3-reader-header .page-indicator {
      font-size: 12px;
      opacity: 0.7;
      white-space: nowrap;
    }
    #ao3-reader-header button {
      background: none;
      border: none;
      font-size: 18px;
      padding: 4px 8px;
    ...
    #ao3-reader-header button:active {
      opacity: 1;
    }
    ...
    #ao3-reader-loading.show {
      display: flex;
    }
    #ao3-reader-loading .loading-card {
      display: flex;
      align-items: center;
      gap: 12px;
      padding: 14px 18px;
      border-radius: 999px;
      color: inherit;
      background: var(--ao3-reader-card-bg, #fff);
      border: 1px solid rgba(128,128,128,0.24);
      box-shadow: 0 8px 28px rgba(0,0,0,0.22);
    }
    #ao3-reader-loading .loading-spinner {
      width: 18px;
      height: 18px;
      border: 2px solid rgba(128,128,128,0.35);
      border-top-color: currentColor;
      border-radius: 50%;
      animation: ao3-reader-spin 0.8s linear infinite;
    }
    ...
    #ao3-reader-footer button:active {
      background: rgba(128,128,128,0.1);
    }
    #ao3-reader-footer button:disabled {
      opacity: 0.3;
    }
    ...
    #ao3-reader-menu.show {
      display: block;
    }
    #ao3-reader-menu .menu-backdrop {
      position: absolute;
      top: 0;
      left: 0;
      width: 100%;
    ...
    #ao3-reader-menu .menu-panel h3 {
      margin: 0 0 14px 0;
      font-size: 16px;
      text-align: center;
    }
    #ao3-reader-menu .menu-row {
      display: flex;
      align-items: center;
      justify-content: space-between;
      margin: 10px 0;
    ...
    #ao3-reader-menu .menu-row button:active {
      background: #ddd;
    }
    #ao3-reader-menu .menu-row select {
      padding: 4px 8px;
      font-size: 14px;
      border-radius: 4px;
      border: 1px solid #ccc;
    }
    #ao3-reader-menu .menu-section-label {
      font-size: 13px;
      font-weight: bold;
      margin: 12px 0 6px;
      padding-top: 8px;
  ...
  function loadSettings() {
    const saved = GM_getValue('ao3ReaderSettings', null);
    if (saved) {
  ...
  function saveSettings() {
    GM_setValue('ao3ReaderSettings', settings);
  }
